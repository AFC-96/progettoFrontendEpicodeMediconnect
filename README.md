...
MediConnect è una web application full-stack (backend mock) per la gestione di visite mediche online.  
La piattaforma consente ai pazienti di prenotare appuntamenti, consultare la propria storia clinica e gestire il proprio profilo medico, mentre i dottori possono gestire le visite, creare consultazioni e visualizzare la storia clinica dei pazienti.
...
```bash
git clone https://github.com/AFC-96/progettoFrontendEpicodeMediconnect.git
cd progettoFrontendEpicodeMediconnect
npm install
```
...
| npm run mock | Avvia il mock API server |
